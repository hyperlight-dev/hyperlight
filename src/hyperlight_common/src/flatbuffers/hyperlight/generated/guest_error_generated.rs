...
impl<'a> GuestError<'a> {
  ...
  pub fn code(&self) -> ErrorCode {
    ...
    unsafe { self._tab.get::<ErrorCode>(GuestError::VT_CODE, Some(ErrorCode::NoError)).unwrap()}
  }
  #[inline]
  pub fn message(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(GuestError::VT_MESSAGE, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GuestErrorBuilder<'a, 'b, A> {
  ...
  pub fn add_code(&mut self, code: ErrorCode) {
    self.fbb_.push_slot::<ErrorCode>(GuestError::VT_CODE, code, ErrorCode::NoError);
  }
  #[inline]
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GuestError::VT_MESSAGE, message);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GuestErrorBuilder<'a, 'b, A> {
...
pub fn size_prefixed_root_as_guest_error(buf: &[u8]) -> Result<GuestError, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_guest_error_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<GuestError<'a>>) {
