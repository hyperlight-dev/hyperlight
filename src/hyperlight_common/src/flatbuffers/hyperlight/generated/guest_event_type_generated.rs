...
pub const ENUM_MAX_GUEST_EVENT_TYPE: u8 = 3;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_GUEST_EVENT_TYPE: [GuestEventType; 4] = [
    GuestEventType::NONE,
...
impl GuestEventType {
    ...
    pub const OpenSpanType: Self = Self(1);
    pub const CloseSpanType: Self = Self(2);
    pub const LogEventType: Self = Self(3);
    ...
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            Self::NONE => Some("NONE"),
            Self::OpenSpanType => Some("OpenSpanType"),
            Self::CloseSpanType => Some("CloseSpanType"),
            Self::LogEventType => Some("LogEventType"),
            _ => None,
        }
    }
}
