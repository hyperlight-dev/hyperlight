...
impl<'a> FunctionCallResult<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.return_value { builder.add_return_value(x); }
  ...
  pub fn return_value_type(&self) -> ReturnValue {
    ...
    unsafe { self._tab.get::<ReturnValue>(FunctionCallResult::VT_RETURN_VALUE_TYPE, Some(ReturnValue::NONE)).unwrap()}
  }
  #[inline]
  pub fn return_value(&self) -> flatbuffers::Table<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(FunctionCallResult::VT_RETURN_VALUE, None).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for FunctionCallResult<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_union::<ReturnValue, _>("return_value_type", Self::VT_RETURN_VALUE_TYPE, "return_value", Self::VT_RETURN_VALUE, true, |key, v, pos| {
        match key {
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FunctionCallResultBuilder<'a, 'b, A> {
  ...
  pub fn add_return_value_type(&mut self, return_value_type: ReturnValue) {
    self.fbb_.push_slot::<ReturnValue>(FunctionCallResult::VT_RETURN_VALUE_TYPE, return_value_type, ReturnValue::NONE);
  }
  #[inline]
  pub fn add_return_value(&mut self, return_value: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FunctionCallResult::VT_RETURN_VALUE, return_value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FunctionCallResultBuilder<'a, 'b, A> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<FunctionCallResult<'a>> {
    ...
    self.fbb_.required(o, FunctionCallResult::VT_RETURN_VALUE,"return_value");
      ...
      match self.return_value_type() {
        ReturnValue::hlint => {
          if let Some(x) = self.return_value_as_hlint() {
            ...
            ds.field("return_value", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        ReturnValue::hluint => {
...
pub fn root_as_function_call_result(buf: &[u8]) -> Result<FunctionCallResult, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_function_call_result(buf: &[u8]) -> Result<FunctionCallResult, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_function_call_result_unchecked(buf: &[u8]) -> FunctionCallResult {
...
#[inline]
pub fn finish_size_prefixed_function_call_result_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<FunctionCallResult<'a>>) {
