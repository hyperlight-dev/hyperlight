...
pub(crate) const LIBC_FILES: &[&str] = &[
    ...
    "stdlib/pico-atexit.c",
    "stdlib/pico-exit.c",
    "stdlib/pico-onexit.c",
    "stdlib/pico-cxa-atexit.c",
    "stdlib/pico-exitprocs.c",
    "string/bcmp.c",
    "string/bcopy.c",
    "string/bzero.c",
    ...
    "picolib/machine/x86/interrupt.S",
    "tinystdio/asnprintf.c",
    "tinystdio/asprintf.c",
    "tinystdio/atomic_load.c",
    "tinystdio/atold_engine.c",
    "tinystdio/bufio.c",
    "tinystdio/clearerr.c",
    "tinystdio/compare_exchange.c",
    "tinystdio/dtox_engine.c",
    "tinystdio/ecvt.c",
    "tinystdio/ecvtf.c",
    "tinystdio/ecvtf_r.c",
    "tinystdio/ecvtl.c",
    ...
    "tinystdio/filewstrget.c",
    "tinystdio/flockfile.c",
    "tinystdio/flockfile_init.c",
    "tinystdio/fmemopen.c",
    "tinystdio/fopen.c",
    "tinystdio/fprintf.c",
    "tinystdio/fputc.c",
    "tinystdio/fputs.c",
    ...
    "tinystdio/ftell.c",
    "tinystdio/ftello.c",
    "tinystdio/ftox_engine.c",
    "tinystdio/ftrylockfile.c",
    "tinystdio/funlockfile.c",
    "tinystdio/funopen.c",
    "tinystdio/fwide.c",
    "tinystdio/fwprintf.c",
    "tinystdio/fwrite.c",
    "tinystdio/fwscanf.c",
    "tinystdio/gcvt.c",
    "tinystdio/gcvtf.c",
    "tinystdio/gcvtl.c",
    "tinystdio/getchar.c",
    "tinystdio/getdelim.c",
    "tinystdio/getline.c",
    "tinystdio/gets.c",
    "tinystdio/getwchar.c",
    "tinystdio/ldtoa_engine.c",
    "tinystdio/ldtox_engine.c",
    "tinystdio/matchcaseprefix.c",
    "tinystdio/mktemp.c",
    "tinystdio/perror.c",
    "tinystdio/posixiob_stdin.c",
    "tinystdio/posixiob_stdout.c",
    "tinystdio/posixiob_stderr.c",
    "tinystdio/printf.c",
    "tinystdio/putchar.c",
    "tinystdio/puts.c",
    "tinystdio/putwchar.c",
    "tinystdio/remove.c",
    "tinystdio/rewind.c",
    "tinystdio/scanf.c",
    "tinystdio/setbuf.c",
    "tinystdio/setbuffer.c",
    "tinystdio/setlinebuf.c",
    "tinystdio/setvbuf.c",
    "tinystdio/sflags.c",
    ...
    "tinystdio/strfroml.c",
    "tinystdio/strtod.c",
    "tinystdio/strtod_l.c",
    "tinystdio/strtof.c",
    "tinystdio/strtof_l.c",
    "tinystdio/strtoimax.c",
    "tinystdio/strtoimax_l.c",
    "tinystdio/strtol.c",
    "tinystdio/strtold.c",
    "tinystdio/strtold_l.c",
    "tinystdio/strtol_l.c",
    "tinystdio/strtoll.c",
    "tinystdio/strtoll_l.c",
    "tinystdio/strtoul.c",
    "tinystdio/strtoul_l.c",
    "tinystdio/strtoull.c",
    "tinystdio/strtoull_l.c",
    "tinystdio/strtoumax.c",
    "tinystdio/strtoumax_l.c",
    "tinystdio/swprintf.c",
    "tinystdio/swscanf.c",
    "tinystdio/tmpfile.c",
    "tinystdio/tmpnam.c",
    "tinystdio/ungetc.c",
    "tinystdio/ungetwc.c",
    "tinystdio/vasnprintf.c",
    "tinystdio/vasprintf.c",
    "tinystdio/vffprintf.c",
    "tinystdio/vffscanf.c",
    "tinystdio/vfiprintf.c",
    "tinystdio/vfiscanf.c",
    "tinystdio/vflprintf.c",
    "tinystdio/vflscanf.c",
    "tinystdio/vfmprintf.c",
    "tinystdio/vfmscanf.c",
    "tinystdio/vfprintf.c",
    "tinystdio/vfscanf.c",
    "tinystdio/vfwprintf.c",
    "tinystdio/vfwscanf.c",
    "tinystdio/vprintf.c",
    "tinystdio/vscanf.c",
    "tinystdio/vsnprintf.c",
    "tinystdio/vsprintf.c",
    "tinystdio/vsscanf.c",
    "tinystdio/vswprintf.c",
    "tinystdio/vswscanf.c",
    "tinystdio/vwprintf.c",
    "tinystdio/vwscanf.c",
    "tinystdio/wcstod.c",
    "tinystdio/wcstod_l.c",
    "tinystdio/wcstof.c",
    "tinystdio/wcstof_l.c",
    "tinystdio/wcstoimax.c",
    "tinystdio/wcstoimax_l.c",
    "tinystdio/wcstol.c",
    "tinystdio/wcstold.c",
    "tinystdio/wcstold_l.c",
    "tinystdio/wcstol_l.c",
    "tinystdio/wcstoll.c",
    "tinystdio/wcstoll_l.c",
    "tinystdio/wcstoul.c",
    "tinystdio/wcstoul_l.c",
    "tinystdio/wcstoull.c",
    "tinystdio/wcstoull_l.c",
    "tinystdio/wcstoumax.c",
    "tinystdio/wcstoumax_l.c",
    "tinystdio/wprintf.c",
    "tinystdio/wscanf.c",
    "tinystdio/sprintf_s.c",
    "tinystdio/vfprintf_s.c",
    "tinystdio/vsnprintf_s.c",
