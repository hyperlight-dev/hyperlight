...
use hyperlight_component_macro::host_bindgen2;
extern crate alloc;
mod bindings2 {
    hyperlight_component_macro::host_bindgen2!({path: "../tests/rust_guests/witguest/interface.wasm", world_name: "test"});
}

use bindings2::test::wit::roundtrip::{Testrecord, Testvariant};
use bindings2::*;
...
mod host_bindgen2_test {

    use proptest::prelude::*;

    use crate::bindings2::test::wit::{Roundtrip, TestExports, TestHostResource, roundtrip};
    use crate::sb;
