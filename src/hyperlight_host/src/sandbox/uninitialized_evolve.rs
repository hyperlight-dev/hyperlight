    ...
    ) -> Result<ResSandbox>,
{
    ...
    let peb_addr = gshm.layout.peb_address as u64;
    ...
    transform(u_sbox.host_funcs, hshm, vm, dispatch_function_addr)
}
...
pub(crate) fn set_up_hypervisor_partition(
    ...
    let rsp_ptr = { mgr.set_up_shared_memory(mgr.shared_mem.mem_size(), &mut regions)? } as u64;
